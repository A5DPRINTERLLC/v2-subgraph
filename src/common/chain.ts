...
// Pairs used for deriving ETH price from stable references
export const STABLE_TOKEN_PAIRS: string[] = [
  ...
  '0x4f96fe3b7a6cf9725f59d353f723c1bdb64ca6aa', // Example placeholder
]

// -------------------------------------------------------------------
// Whitelist: tokens whose volume & liquidity you want to track fully
// Must be string[] for AssemblyScript
// -------------------------------------------------------------------
export const WHITELIST: string[] = [
  ...
  '0xdf5e0e81dff6faf3a7e52ba697820c5e32d806a8', // yCurve
...
// -------------------------------------------------------------------
// Stablecoins: If you want to consider certain tokens as "stable" in 
// pricing logic, put them here. By default, it's empty.
// -------------------------------------------------------------------
...
// -------------------------------------------------------------------
// Additional Token Definitions (Optional metadata)
// -------------------------------------------------------------------
...
// Some addresses you want to skip on totalSupply calls, etc.
